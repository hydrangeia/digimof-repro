...
from ..parse.battery_conductivity import ConductivityParser
from ..parse.battery_coulombic import CoulombicParser
from ..parse.battery_voltage import VoltageParser
from ..parse.mof_topology import cem_TpParser
from ..parse.heat_of_adsorption import AdsParser
from ..parse.synthesis import SRParser
from ..parse.ir import IrParser
from ..parse.organic_precursor import LinkerParser
...
class Paragraph(Text):
    ...
    parsers = [CompoundParser(), ChemicalLabelParser(), ContextParser(), LinkerParser(), SRParser(), cem_TpParser()]
...
class Caption(Text):
    parsers = [CompoundParser(), ChemicalLabelParser(), CaptionContextParser(), cem_TpParser(), SRParser(), LinkerParser()]
