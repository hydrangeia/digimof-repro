...
def test_heuristic_mof_handles_en_dash_spelling():
    text = (
        "The reaction gave rise to a metal–organic framework (MOF), "
        "CaNDC-MOF, was synthesized under hydrothermal conditions."
    )
